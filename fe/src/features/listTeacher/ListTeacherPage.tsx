...
const ListTeacherPage = () => {
    ...
    const { major: allMajor } = useAppSelector((state) => state.getMajor)
    ...
    return (
        <div className='p-[50px] min-h-screen bg-[#F3F4FF]'>
            ...
            <div className='mb-[25px] flex justify-between'>
                ...
                <div className='flex gap-5 '>
                    <select className='hover:cursor-pointer text-[20px] bg-white text-[#4D44B5] p-5 rounded-full' onChange={(e) => dispatch(setMajor(e.target.value))} name="" id="">
